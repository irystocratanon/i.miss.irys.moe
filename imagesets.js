...
export const ERROR_IMAGE_SET = importAll(
    require.context('./public/imagesets/errored', false, /\.(gif|png|jpe?g|svg)$/),
    'imagesets/errored/'
);

export const HAVE_STREAM_IMAGE_SET = importAll(
    require.context('./public/imagesets/have-stream', false, /\.(gif|png|jpe?g|svg)$/),
    'imagesets/have-stream/'
);

export const NO_STREAM_IMAGE_SET = importAll(
    require.context('./public/imagesets/no-stream', false, /\.(gif|png|jpe?g|svg)$/),
    'imagesets/no-stream/'
);
